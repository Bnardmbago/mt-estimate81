...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "none": "None",
        "executive_cost_summary": "Executive Cost Summary",
        "estimate_id": "Estimate ID",
        "export_revision": "Version",
        "estimate_type": "Estimate Type",
        "amount_jpy": "Amount (JPY)",
        "monthly_rc": "Monthly RC",
        "annual_rc": "Annual RC",
        "first_year_total_cost": "First Year Total Cost",
        "total_development_cost": "Total Development Cost (deployment and Delivery acceptance)",
        ...
        "gantt_assumption": "Working days Mon-Fri; sequential tasks; no public holidays.",
    ...
    "ja": {
        ...
        "none": "なし",
        "executive_cost_summary": "エグゼクティブコストサマリー",
        "estimate_id": "見積ID",
        "export_revision": "バージョン",
        "estimate_type": "見積種別",
        "amount_jpy": "金額（JPY）",
        "monthly_rc": "月額RC",
        "annual_rc": "年額RC",
        "first_year_total_cost": "初年度合計コスト",
        "total_development_cost": "開発費用合計（デプロイ・引渡し検収まで）",
        ...
        "approval_date": "日付",
        "prepared_by_value": "AI Driven Estimate System",
        "nrc_total_formula": "NRC合計 = すべてのNRC項目の合計",
        "rc_monthly_formula": "月額RC合計",
        "rc_annual_formula": "年額RC合計",
        "gantt_title": "プロジェクトタイムライン（ガント）",
        "gantt_assumption": "稼働日は月〜金。タスクは順次実行。祝日は考慮しません。",
